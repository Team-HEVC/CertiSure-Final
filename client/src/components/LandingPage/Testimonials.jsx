    ...
    const testimonials = [
        {
            ...
            quote: "Generate certificates quickly and efficiently with Certisure. It's a game-changer for our organization."
        },
        {
            avatar: "https://randomuser.me/api/portraits/men/2.jpg",
            name: "Amit Singh",
            title: "Software Engineer",
            quote: "I've never seen a more user-friendly certificate service. Certisure makes my job so much easier."
        },
        {
            avatar: "https://randomuser.me/api/portraits/men/3.jpg",
            name: "Nehan Sharma",
            title: "Product Designer",
            quote: "Certisure's flexibility is outstanding. It allows us to create certificates that match our brand perfectly."
        },
    ]

    return (
        <section className="relative text-ascent mt-20 py-14">
            <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="max-w-xl sm:text-center md:mx-auto">
                    ...
                    <p className="mt-3">
                        Discover what our satisfied customers have to say about their experience with Certisure. We take pride in delivering a seamless certificate generation and verification solution that meets their needs.
                    </p>
                </div>
                <div className="mt-12">
                    <ul className="grid items-center gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {
                            testimonials.map((item, idx) => (
                                <li key={idx} className=" rounded-xl border shadow-md">
                                    <div className="p-4">
                                        <svg className="w-9 h-9" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="absolute top-0 w-full h-[200px]" style={{ background: "linear-gradient(152.92deg, rgba(192, 132, 252, 0.2) 4.54%, rgba(232, 121, 249, 0.17) 34.2%, rgba(192, 132, 252, 0.1) 77.55%)" }}></div>
        </section>
    )
}
