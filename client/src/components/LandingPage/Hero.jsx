...
const Hero = () => {
    return (
        <section>
            <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-ascent overflow-hidden md:px-8 md:flex">
                <div className='flex-none space-y-5 max-w-xl'>
                    ...
                    <h1 className="text-4xl font-extrabold sm:text-5xl">
                        Generate certificates quick and easy
                    </h1>
                    <p>
                        Unlocking Trust Through Innovation: Your Premier Destination for Effortless Certificate Generation and Seamless Verification
                    </p>
                    <div className='flex items-center gap-x-3 sm:text-sm'>
                        <Link to='/signup' href="javascript:void(0)" className="flex items-center justify-center gap-x-1 py-2 px-4 text-white font-medium bg-gray-800 duration-150 hover:bg-gray-700 active:bg-gray-900 rounded-full md:inline-flex">
                            Get started
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                                <path fillRule="evenodd" d="M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clipRule="evenodd" />
                            </svg>
                        </Link>
                        <a href="javascript:void(0)" className="flex items-center justify-center gap-x-1 py-2 px-4 hover:text-gray-900 font-medium duration-150 md:inline-flex">
                            Contact sales
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                                <path fillRule="evenodd" d="M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clipRule="evenodd" />
                            </svg>
                ...
                <div className='flex-1 hidden md:block'>
                    ...
                    <video src={video} autoPlay loop muted className="max-w-xl"/>
