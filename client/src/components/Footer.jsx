          ...
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="max-w-sm flex items-center rounded-md p-1">
              <input
                ...
                className="w-full bg-slate-100 rounded-l-md p-2.5 outline-none"
              />
              <button className="p-2.5 rounded-r-md text-white bg-indigo-600 outline-none shadow-md focus:shadow-none sm:px-5">
                Subscribe
              </button>
            </div>
          </form>
